...
class TestShape
{
  public static void main(String[] args)
  {
    ...
    { System.out.println("\nDeafult:");
      ...
      {
        System.out.println("\nRectangle:\n");
        System.out.println("Length:\t"+((Rectangle)s[1]).getLength());
        System.out.println("Width:\t"+((Rectangle)s[1]).getWidth());
      } 
      else
      {
        System.out.println("\nSquare:\n");
        System.out.println("Side:\t"+((Square)s[2]).getSide());
      }
    ...
    { 
      ...
      if(i==0)
      {
        ...
        ((Circle)s[0]).setRadius(scan.nextFloat());
        scan.nextLine();
        System.out.print("Enter new Color: ");
        ((Circle)s[0]).setColor(scan.nextLine());
        System.out.println("\nadius:\t"+((Circle)s[0]).getRadius());
      }
      else if(i==1)
      {
        System.out.println("\nRectangle:\n");
        System.out.print("Enter new Length: ");
        ((Rectangle)s[1]).setLength(scan.nextFloat());
        scan.nextLine();
        System.out.print("Enter new Width: ");
        ((Rectangle)s[1]).setWidth(scan.nextFloat());
        scan.nextLine();
        System.out.print("Enter new Color: ");
        ((Rectangle)s[1]).setColor(scan.nextLine());
        System.out.println("\nLength:\t"+((Rectangle)s[1]).getLength());
        System.out.println("Width:\t"+((Rectangle)s[1]).getWidth());
      } 
      else
      {
        ...
        ((Square)s[2]).setSide(scan.nextFloat());
        scan.nextLine();
        System.out.print("Enter new Color: ");
        ((Square)s[2]).setColor(scan.nextLine());
        System.out.println("\nSide:\t"+((Square)s[2]).getSide());
      }
      System.out.println("Color:\t"+s[i].getColor());
      System.out.println("Area:\t"+s[i].getArea());
      System.out.println("Perimeter:"+s[i].getPerimeter());
